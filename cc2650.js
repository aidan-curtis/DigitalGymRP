...
CC2650SensorTag.prototype.onMPU9250Change = function(data) {
  this.convertMPU9250Data(data, function(x, y, z, xG, yG, zG, xM, yM, zM) {
    if((this.mpu9250mask & MPU9250_ACCELEROMETER_MASK) && (this.mpu9250mask & MPU9250_GYROSCOPE_MASK) && (this.mpu9250mask & MPU9250_MAGNETOMETER_MASK)){
      this.emit('9axisChange', x, y, z, xG, yG, zG, xM, yM, zM);    //Added this to allow all 9 axes to be sent at once in an event
    }
